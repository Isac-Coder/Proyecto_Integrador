...
CREATE TABLE usuarios_sistema(
    ...
    CONSTRAINT usuarios_sistema_rol_check CHECK ((rol)::text = ANY ((ARRAY['Administrador'::character varying, 'Profesional'::character varying, 'Cuidador'::character varying])::text[])) 
); 
